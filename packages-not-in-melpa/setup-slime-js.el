...
(require 'slime)
(require 'slime-js)
;hacks to make completion works with swank-js
;(setq slime-complete-symbol-function 'slime-simple-complete-symbol)
;(slime-setup '(slime-js slime-repl))

(push "~/.emacs.d/js2" load-path)
(push "~/.emacs.d/js2/js2-refactor" load-path) 
(push "~/.emacs.d/js2/mark-multiple" load-path) 
(push "~/.emacs.d/js2/dash" load-path) 
(push "~/.emacs.d/mooz-js2-mode" load-path)
(require 'js2-refactor)

(setq slime-js-target-url "http://localhost:8000")
...
(setq slime-js-browser-command "iceweasel") ;"open -a Safari")
